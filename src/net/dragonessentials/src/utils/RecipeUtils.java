 ...
 * Useful for identifying your recipes in events, where recipes are re-generated
 * in a diferent manner.
 * 
 * @version R1.3
 * @author Digi
 */
public class RecipeUtils {
	 ...
	 * @throws IllegalArgumentException if recipe is other than ShapedRecipe,
	 *                                  ShapelessRecipe or FurnaceRecipe.
	 */
	...
	private static boolean match(Recipe recipe1, Recipe recipe2) {
		if (recipe1 instanceof ShapedRecipe) {
			...
			if (!Arrays.equals(matrix1, matrix2)) // compare arrays and if they don't match run another check with one
													// shape mirrored.
			{
			...
			// return (r1.getInput().equals(r2.getInput())); // TODO use this when furnace
			// data PR is pulled
